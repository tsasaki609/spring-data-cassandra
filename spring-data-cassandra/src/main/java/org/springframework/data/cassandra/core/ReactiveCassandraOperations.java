...
public interface ReactiveCassandraOperations extends ReactiveFluentCassandraOperations {
	 ...
	 * @throws DataAccessException if there is any problem issuing the execution.
	 */
	<S extends Statement<S>, T> Flux<T> select(Statement<S> statement, Class<T> entityClass) throws DataAccessException;
	 ...
	 * @since 2.1
	 */
	<S extends Statement<S>, T> Mono<Slice<T>> slice(Statement<S> statement, Class<T> entityClass) throws DataAccessException;
	 ...
	 * @throws DataAccessException if there is any problem issuing the execution.
	 */
	<S extends Statement<S>, T> Mono<T> selectOne(Statement<S> statement, Class<T> entityClass) throws DataAccessException;
