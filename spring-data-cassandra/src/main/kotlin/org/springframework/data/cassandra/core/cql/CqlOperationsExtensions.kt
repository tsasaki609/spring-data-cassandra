...
fun <S : Statement<S>, T : Any> CqlOperations.queryForObject(statement: Statement<S>, entityClass: KClass<T>): T? =
		queryForObject(statement, entityClass.java)

/**
 * Extension for [CqlOperations.queryForObject] leveraging reified type parameters.
 */
inline fun <S : Statement<S>, reified T : Any> CqlOperations.queryForObject(statement: Statement<S>): T? =
...
fun <S : Statement<S>, T : Any> CqlOperations.queryForList(statement: Statement<S>, entityClass: KClass<T>): List<T> =
 ...
 */
@Suppress("EXTENSION_SHADOWED_BY_MEMBER")
inline fun <S : Statement<S>, reified T : Any> CqlOperations.queryForList(statement: Statement<S>): List<T> =
