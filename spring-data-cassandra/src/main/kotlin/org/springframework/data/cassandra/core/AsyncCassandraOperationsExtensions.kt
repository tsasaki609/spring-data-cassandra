...
// -------------------------------------------------------------------------
// Methods dealing with com.datastax.driver.core.Statement TODO
// -------------------------------------------------------------------------
...
fun <S : Statement<S>, T : Any> AsyncCassandraOperations.select(statement: Statement<S>, entityClass: KClass<T>): ListenableFuture<List<T>> =
		select(statement, entityClass.java)

/**
 * Extension for [AsyncCassandraOperations.select] leveraging reified type parameters.
 */
inline fun <S : Statement<S>, reified T : Any> AsyncCassandraOperations.select(statement: Statement<S>): ListenableFuture<List<T>> =
...
fun <S : Statement<S>, T : Any> AsyncCassandraOperations.select(statement: Statement<S>, entityClass: KClass<T>, consumer: (T) -> Unit): ListenableFuture<Void> =
		select(statement, consumer, entityClass.java)

/**
 * Extension for [AsyncCassandraOperations.select] providing a Consumer-like function leveraging reified type parameters.
 */
inline fun <S : Statement<S>, reified T : Any> AsyncCassandraOperations.select(statement: Statement<S>, crossinline consumer: (T) -> Unit): ListenableFuture<Void> =
...
fun <S : Statement<S>, T : Any> AsyncCassandraOperations.slice(statement: Statement<S>, entityClass: KClass<T>): ListenableFuture<Slice<T>> =
		slice(statement, entityClass.java)

/**
 * Extension for [AsyncCassandraOperations.slice] leveraging reified type parameters.
 */
inline fun <S : Statement<S>, reified T : Any> AsyncCassandraOperations.slice(statement: Statement<S>): ListenableFuture<Slice<T>> =
...
fun <S : Statement<S>, T : Any> AsyncCassandraOperations.selectOne(statement: Statement<S>, entityClass: KClass<T>): ListenableFuture<T?> =
		selectOne(statement, entityClass.java)

/**
 * Extension for [AsyncCassandraOperations.selectOne] leveraging reified type parameters.
 */
inline fun <S : Statement<S>, reified T : Any> AsyncCassandraOperations.selectOne(statement: Statement<S>): ListenableFuture<T?> =
