...
fun <S : Statement<S>, T : Any> ReactiveCqlOperations.queryForObject(statement: Statement<S>, entityClass: KClass<T>): Mono<T> =
		queryForObject(statement, entityClass.java)

/**
 * Extension for [ReactiveCqlOperations.queryForObject] leveraging reified type parameters.
 */
inline fun <S : Statement<S>, reified T : Any> ReactiveCqlOperations.queryForObject(statement: Statement<S>): Mono<T> =
...
fun <S : Statement<S>, T : Any> ReactiveCqlOperations.queryForFlux(statement: Statement<S>, entityClass: KClass<T>): Flux<T> =
 ...
 */
@Suppress("EXTENSION_SHADOWED_BY_MEMBER")
inline fun <S : Statement<S>, reified T : Any> ReactiveCqlOperations.queryForFlux(statement: Statement<S>): Flux<T> =
